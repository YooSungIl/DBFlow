...
public class CollectColumnSnapshot {
    private Long collectColumnId;
    ...
    public Long getCollectColumnId() {
        return collectColumnId;
    }

    public void setCollectColumnId(Long collectColumnId) {
        this.collectColumnId = collectColumnId;
    }
